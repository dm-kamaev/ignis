...
var Executor = /** @class */ (function () {
    ...
    Executor.prototype._make_request = function (req, $el, spinner, url) {
        var _this = this;
        var manager_long_request = spinner ? new Manager_Long_Request_1.default(this.life_hooks.longRequest, $el).start() : { end: function () { } };
        req.then(function (resp) { return _this._handle_response(resp, url); }).catch(this._handler_error.bind(this)).finally(manager_long_request.end.bind(manager_long_request));
    };
    Executor.prototype._handle_response = function (resp, url) {
        var _this = this;
        ...
        if (this.el.$el.hasAttribute('data-i-push-url')) {
            history.pushState({ v: 'ignis-html:1', url: url }, '', url);
        }
    };
...
var Manager_Long_Request = /** @class */ (function () {
    function Manager_Long_Request(_spinner, _$el) {
    ...
    Manager_Long_Request.prototype.start = function () {
        ...
        var idle = setInterval(function () {
            ...
            if (!_this._is_finished && (now - _this._start_request) > _this._delay) {
                ...
                _this._spinner.start(_this._$el);
                clearInterval(idle);
            }
    ...
    Manager_Long_Request.prototype.end = function () {
        ...
        if (diff < this._min_diff_between_start_stop) {
            ...
            setTimeout(function () {
                _this._spinner.stop(_this._$el);
            }, ms);
        }
        else {
...
/*!*********************************!*\
  !*** ./client/example_start.ts ***!
  \*********************************/

Object.defineProperty(exports, "__esModule", ({ value: true }));
var ignis_1 = __webpack_require__(/*! ./ignis */ "./client/ignis.ts");
ignis_1.default.start({
