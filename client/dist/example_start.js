...
/***/ "./node_modules/forms_to_json/index.js":
/*!*********************************************!*\
  !*** ./node_modules/forms_to_json/index.js ***!
  \*********************************************/
...
/* harmony export */   "default": () => (/* binding */ FormToJSON)
/* harmony export */ });
/* harmony import */ var promise_mtd__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! promise_mtd */ "./node_modules/promise_mtd/index.js");
/* harmony import */ var promise_mtd__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(promise_mtd__WEBPACK_IMPORTED_MODULE_0__);
...
class FormToJSON {
  ...
  parseWithFiles() {
    ...
    return promise_mtd__WEBPACK_IMPORTED_MODULE_0___default().forEach(inputs, function (input) {
      const name = input.name;
      if (input.multiple) {
        return promise_mtd__WEBPACK_IMPORTED_MODULE_0___default().forEach(input.files, file => {
...
/***/ "./node_modules/promise_mtd/index.js":
/*!*******************************************!*\
  !*** ./node_modules/promise_mtd/index.js ***!
  \*******************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
promise_mtd.foreach = promise_mtd.forEach = __webpack_require__(/*! ./src/foreach.js */ "./node_modules/promise_mtd/src/foreach.js");

promise_mtd.map = __webpack_require__(/*! ./src/map.js */ "./node_modules/promise_mtd/src/map.js");

promise_mtd.filter = __webpack_require__(/*! ./src/filter.js */ "./node_modules/promise_mtd/src/filter.js");

promise_mtd.find = __webpack_require__(/*! ./src/find.js */ "./node_modules/promise_mtd/src/find.js");

promise_mtd.reduce = __webpack_require__(/*! ./src/reduce.js */ "./node_modules/promise_mtd/src/reduce.js");

promise_mtd.transform = __webpack_require__(/*! ./src/transform.js */ "./node_modules/promise_mtd/src/transform.js");

promise_mtd.async_while = promise_mtd.asyncWhile = __webpack_require__(/*! ./src/async_while.js */ "./node_modules/promise_mtd/src/async_while.js");

promise_mtd.parallel = __webpack_require__(/*! ./src/parallel.js */ "./node_modules/promise_mtd/src/parallel.js");

promise_mtd.all = __webpack_require__(/*! ./src/all.js */ "./node_modules/promise_mtd/src/all.js");

promise_mtd.setImmediate = promise_mtd.set_immediate = __webpack_require__(/*! ./src/setImmediate.js */ "./node_modules/promise_mtd/src/setImmediate.js");


/***/ }),

/***/ "./node_modules/promise_mtd/src/all.js":
/*!*********************************************!*\
  !*** ./node_modules/promise_mtd/src/all.js ***!
  \*********************************************/
/***/ ((module) => {
...
/***/ "./node_modules/promise_mtd/src/async_while.js":
/*!*****************************************************!*\
  !*** ./node_modules/promise_mtd/src/async_while.js ***!
  \*****************************************************/
/***/ ((module) => {
...
/***/ "./node_modules/promise_mtd/src/filter.js":
/*!************************************************!*\
  !*** ./node_modules/promise_mtd/src/filter.js ***!
  \************************************************/
/***/ ((module) => {
...
/***/ "./node_modules/promise_mtd/src/find.js":
/*!**********************************************!*\
  !*** ./node_modules/promise_mtd/src/find.js ***!
  \**********************************************/
/***/ ((module) => {
...
/***/ "./node_modules/promise_mtd/src/foreach.js":
/*!*************************************************!*\
  !*** ./node_modules/promise_mtd/src/foreach.js ***!
  \*************************************************/
/***/ ((module) => {
...
/***/ "./node_modules/promise_mtd/src/map.js":
/*!*********************************************!*\
  !*** ./node_modules/promise_mtd/src/map.js ***!
  \*********************************************/
/***/ ((module) => {
...
/***/ "./node_modules/promise_mtd/src/parallel.js":
/*!**************************************************!*\
  !*** ./node_modules/promise_mtd/src/parallel.js ***!
  \**************************************************/
/***/ ((module) => {
...
/***/ "./node_modules/promise_mtd/src/reduce.js":
/*!************************************************!*\
  !*** ./node_modules/promise_mtd/src/reduce.js ***!
  \************************************************/
/***/ ((module) => {
...
/***/ "./node_modules/promise_mtd/src/setImmediate.js":
/*!******************************************************!*\
  !*** ./node_modules/promise_mtd/src/setImmediate.js ***!
  \******************************************************/
/***/ ((module) => {
...
/***/ "./node_modules/promise_mtd/src/transform.js":
/*!***************************************************!*\
  !*** ./node_modules/promise_mtd/src/transform.js ***!
  \***************************************************/
/***/ ((module) => {
...
var helper_1 = __webpack_require__(/*! ./helper */ "./client/helper.ts");
var El = /** @class */ (function () {
    function El($el, cmds) {
        this.$el = $el;
        this.cmds = cmds;
        this._idle_for_debounce = null;
        this._old_val = null;
        this._idle_for_every = null;
    }
    El.prototype.set_debounce_cb = function (cb, mod_debounce) {
    ...
    El.prototype.set_idle_for_every = function (idle) {
        this._idle_for_every = idle;
    };
    El.prototype.abort_every = function () {
        if (this._idle_for_every) {
            clearInterval(this._idle_for_every);
            console.log('ABort!');
        }
    };
    El.prototype.set_request_id = function () {
        return this._request_id = (0, helper_1.get_uid)();
    };
    El.prototype.get_request_id = function () {
        return this._request_id;
    };
    El.prototype.is_not_changed = function ($el, mod_changed) {
        var current = "".concat(mod_changed.prop) in $el ? $el[mod_changed.prop] : $el.getAttribute(mod_changed.prop);
        var result = current === this._old_val;
        if (!result) {
            this._old_val = current;
        }
        return result;
    };
    El.prototype.revoke_cmd = function (name) {
        this.cmds = this.cmds.filter(function (el) { return el.name !== name; });
    };
    return El;
}());
exports["default"] = El;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var forms_to_json_1 = __webpack_require__(/*! forms_to_json */ "./node_modules/forms_to_json/index.js");
var morphdom_1 = __webpack_require__(/*! morphdom */ "./node_modules/morphdom/dist/morphdom-esm.js");
var helper_1 = __webpack_require__(/*! ./helper */ "./client/helper.ts");
var Manager_Long_Request_1 = __webpack_require__(/*! ./Manager_Long_Request */ "./client/Manager_Long_Request.ts");
var enum_attr_1 = __webpack_require__(/*! ./enum_attr */ "./client/enum_attr.ts");
var Executor = /** @class */ (function () {
    function Executor(life_hooks, el, axios) {
        this.el = el;
        this.$el = el.$el;
        this.life_hooks = life_hooks;
        this.axios = axios;
    }
    Executor.prototype.run_as_form = function (e, cmd, _a) {
        var _b;
        var spinner = _a.spinner;
        e.preventDefault();
        ...
        var url = cmd.url;
        var enctype = (_b = $el.getAttribute('data-i-enctype')) === null || _b === void 0 ? void 0 : _b.trim();
        ...
        var $form = (0, helper_1.getTarget)(e);
        var req;
        var method_name = method.toLowerCase();
        var headers = this._build_headers({ id: id, output_id: output_id, request_id: this.el.set_request_id(), });
        ...
        var manager_long_request = spinner ? new Manager_Long_Request_1.default(this.life_hooks.longRequest).start() : { end: function () { } };
    ...
    Executor.prototype.run_as_el = function (e, cmd, settings) {
        e.preventDefault();
        this._run(cmd, settings);
    };
    Executor.prototype.run_as_every = function (cmd, settings) {
        this._run(cmd, settings);
    };
    Executor.prototype._run = function (cmd, _a) {
        var spinner = _a.spinner;
        var axios = this.axios;
        var $el = this.$el;
        var id = $el.id;
        ...
        var headers = this._build_headers({ id: id, output_id: output_id, request_id: this.el.set_request_id(), });
        var req;
        var json = this._extract_data($el, cmd.name);
        if (method === 'GET' || method === 'DELETE') {
            console.log(json, method, url);
            url = this._form_add_to_url(url, json);
    ...
    Executor.prototype._extract_data = function ($el, name) {
        var obj = $el.hasAttribute("data-i-info-".concat(name, "-js")) ? { attr: "data-i-info-".concat(name, "-js"), js: true } :
            $el.hasAttribute("data-i-info-".concat(name)) ? { attr: "data-i-info-".concat(name), js: false } :
                $el.hasAttribute('data-i-info-js') ? { attr: 'data-i-info-js', js: true } :
                    { attr: 'data-i-info', js: false };
        if (obj.js) {
            var expr = $el.getAttribute(obj.attr);
            var code = "with(this){".concat("return ".concat(expr), "}");
            var fn = new Function(code).bind($el);
            console.log('RESULT', fn());
            return fn();
        }
        else {
            var str_data = $el.getAttribute(obj.attr);
            if (!str_data) {
                return {};
            }
    ...
    Executor.prototype._handle_response = function (resp) {
        var _this = this;
        var _ = resp.config, headers = resp.headers, data = resp.data;
        ...
        if (data instanceof Array) {
            data.forEach(function (cmd) { return _this._apply_response(cmd); });
        }
        else if (data) {
            var html = data;
            this._apply_response({ ev: 'update', data: { html: html, css: undefined } });
        }
        else if (headers['x-ignis-redirect-to']) {
            window.location.href = headers['x-ignis-redirect-to'];
        }
    };
    Executor.prototype._handler_error = function (err) {
        this.life_hooks.onError(err);
    };
    Executor.prototype._apply_response = function (resp) {
        if (resp.ev === 'update') {
            var _a = resp.data, html = _a.html, css = _a.css;
            var id = resp.data.id || this._extract_id(resp.data.html);
            console.log({ id: id, html: html });
            this._apply_css(css);
            this._render(id, html);
        }
        else if (resp.ev === 'remove') {
            var $el = (0, helper_1.getById)(resp.data.id);
            if (!$el) {
            ...
            var _b = resp.data, id = _b.id, html = _b.html, css = _b.css;
            this._apply_css(css);
            var $el = (0, helper_1.getById)(id);
            if (!$el) {
            ...
            var _c = resp.data, id = _c.id, html = _c.html, css = _c.css;
            this._apply_css(css);
            var $el = (0, helper_1.getById)(id);
            if (!$el) {
    ...
    Executor.prototype._render = function (id, html) {
        var target = (0, helper_1.getById)(id);
        if (!target) {
            throw new Error("Not found element with id: #".concat(id));
        }
        (0, morphdom_1.default)(target, html, options_for_render);
    };
    Executor.prototype._is_absolute_url = function (url) {
        return new RegExp('^(https?:)?//').test(url);
    };
    Executor.prototype._create_url_obj = function (url) {
        return this._is_absolute_url(url) ? new URL(url) : new URL(url, document.baseURI);
    };
    Executor.prototype._apply_css = function (css) {
        if (css) {
            (0, helper_1.addCss)(css);
        }
    };
    Executor.prototype._extract_id = function (html) {
    ...
    Executor.prototype._build_headers = function (_a) {
        var id = _a.id, output_id = _a.output_id, request_id = _a.request_id;
        return {
    ...
    Executor.prototype._form_add_to_url = function (url, data) {
...
var options_for_render = {
    onBeforeElUpdated: function (fromEl, toEl) {
        if (toEl.tagName === 'INPUT') {
            var use_prev_value = toEl.hasAttribute(enum_attr_1.default.PRESERVE);
        ...
        else if (toEl.tagName === 'SELECT' && toEl.hasAttribute(enum_attr_1.default.PRESERVE)) {
            toEl.value = fromEl.value;
        }
        return true;
    }
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var modificator_1 = __webpack_require__(/*! ./modificator */ "./client/modificator.ts");
var Executor_1 = __webpack_require__(/*! ./Executor */ "./client/Executor.ts");
var El_1 = __webpack_require__(/*! ./El */ "./client/El.ts");
var enum_attr_1 = __webpack_require__(/*! ./enum_attr */ "./client/enum_attr.ts");
var Manager = /** @class */ (function () {
    function Manager(life_hooks, axios) {
        this.life_hooks = life_hooks;
        this.axios = axios;
        this.list = [];
    }
    Manager.get_selector = function () {
        return '[' + enum_attr_1.default.EV + ']';
    };
    Manager.get_els = function (node) {
        if (node === void 0) { node = document; }
        return Array.from(node.querySelectorAll(Manager.get_selector()));
    };
    Manager.prototype.start = function () {
        var $els = Manager.get_els();
        this.append($els);
        return this;
    };
    ...
    Manager.prototype._subscribe = function ($el) {
        var _this = this;
        var cmds = this.parse_cmds($el);
        var el = new El_1.default($el, cmds);
    ...
    Manager.prototype._bind_cmd = function (el, _a) {
        ...
        var executor = new Executor_1.default(this.life_hooks, el, this.axios);
        if (Every.is(name)) {
            var every_1 = new Every(name);
            var exec = function () {
                var idle = setInterval(function () {
                    ...
                    if (!document.contains($el)) {
                        el.abort_every();
                        _this.list = _this.list.filter(function (el) { return el.$el === $el; });
                        return;
                    }
        ...
        var cb = function (e) {
            ...
            var exec;
            var spinner = !Boolean($el.hasAttribute('data-i-spinner-off'));
            if (name === 'submit') {
                exec = function () { return executor.run_as_form(e, cmd, { spinner: spinner }); };
            }
            else {
                exec = function () { return executor.run_as_el(e, cmd, { spinner: spinner }); };
            }
            var mods = cmd.mods;
            if (mods.changed) {
        ...
        var once = ((_b = this.parse_cmds($el).find(function (el) { return el.name === name; })) === null || _b === void 0 ? void 0 : _b.mods.once) ? true : false;
        $el.addEventListener(name, cb, { once: once });
    };
    Manager.prototype.parse_cmds = function ($el) {
        var _this = this;
        var evs = $el.getAttribute('data-i-ev');
        if (!evs) {
            return [];
        }
        var cmds_str = evs.trim().split(/\s+/);
        return cmds_str.map(function (el) { return _this.parse_cmd(el); });
    };
    Manager.prototype.parse_cmd = function (cmd) {
        var _a = cmd.split('->'), name = _a[0], method_url = _a[1], modificators = _a[2];
        var m = method_url.match(/(\w+):(.+)/);
        var method = m[1].trim();
        var url = m[2];
        var list_mod = (modificators || '').trim().split(',').map(function (el) { return el.trim(); }).filter(Boolean);
        var mods = {};
        list_mod.forEach(function (el) {
            if (modificator_1.Once.is(el)) {
                mods.once = new modificator_1.Once(el);
            }
            else if (modificator_1.Debounce.is(el)) {
                mods.debounce = new modificator_1.Debounce(el);
            }
            else if (modificator_1.Changed.is(el)) {
                mods.changed = new modificator_1.Changed(el);
            }
            else {
                throw new Error('Unknown modificator ' + el + ', command = ' + cmd);
            }
        });
        return { name: name, method: method, url: url, mods: mods };
    };
    return Manager;
}());
...
var Every = /** @class */ (function () {
    function Every(el) {
        var m = el.match(/^@every\((\d+)(ms|s|m)\)$/);
        if (!m) {
            throw new Error('Invalid event: ' + el);
        }
        var number = parseInt(m[1].trim(), 10);
        var measure = m[2].trim();
        switch (measure) {
            case 'ms':
                this._delay = number;
                break;
    ...
    Every.is = function (el) {
        return /^@every\(\d+(ms|s|m)\)$/.test(el);
    };
    Every.prototype.get_delay_as_ms = function () {
        return this._delay;
    };
    return Every;
}());
...
/***/ "./client/Manager_Long_Request.ts":
/*!****************************************!*\
  !*** ./client/Manager_Long_Request.ts ***!
  \****************************************/
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var Manager_Long_Request = /** @class */ (function () {
    function Manager_Long_Request(longRequest) {
        ...
        var min_time_for_loader = 1000; //  1 second
        this._min_diff_between_start_stop = min_time_for_loader - this._delay; // We protect from flickering when show "loader"
    }
    Manager_Long_Request.prototype.start = function () {
        var _this = this;
        this._start_request = Date.now();
        // We listening request for detecting long delay
        var idle = setInterval(function () {
            var now = Date.now();
            if (!_this._is_finished && (now - _this._start_request) > _this._delay) {
                _this._is_long_request = true;
                _this._longRequest.start();
                clearInterval(idle);
            }
            else if (_this._is_finished) {
                clearInterval(idle);
            }
        }, 100);
        return this;
    };
    Manager_Long_Request.prototype.end = function () {
        var _this = this;
    ...
    return Manager_Long_Request;
}());
exports["default"] = Manager_Long_Request;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.get_uid = exports.getTarget = exports.addCss = exports.getById = void 0;
var D = document;
...
var Manager_1 = __webpack_require__(/*! ./Manager */ "./client/Manager.ts");
var enum_attr_1 = __webpack_require__(/*! ./enum_attr */ "./client/enum_attr.ts");
function start(options) {
    ...
    var manager = new Manager_1.default(life_hooks, req).start();
    var observer = new MutationObserver(function (mutationRecords) {
        for (var _i = 0, mutationRecords_1 = mutationRecords; _i < mutationRecords_1.length; _i++) {
            ...
            for (var _a = 0, _b = Array.from(mutation.addedNodes); _a < _b.length; _a++) {
                ...
                if (node.matches(Manager_1.default.get_selector())) {
                    manager.append([node]);
                }
                // или, может быть, пример кода есть в его поддереве?
                manager.append(Manager_1.default.get_els(node));
            }
            //
            if (mutation.type === 'attributes' && mutation.attributeName === enum_attr_1.default.EV) {
                var t = mutation.target;
                manager.bindings_new_cmds(t);
            }
        }
    });
    ...
    observer.observe(document.body, {
        ...
        subtree: true,
        attributes: true,
        attributeFilter: [enum_attr_1.default.EV],
    });
}
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.Changed = exports.Debounce = exports.Once = void 0;
var Modificator = /** @class */ (function () {
    function Modificator() {
    }
    Modificator.is = function (el) { return false; };
    ;
    Modificator.prototype.new = function (el) { };
    ;
    return Modificator;
}());
var Once = /** @class */ (function (_super) {
...
var Debounce = /** @class */ (function (_super) {
    ...
    function Debounce(el) {
        ...
        var m = el.match(/^debounce\((\d+)(ms|s|m)\)$/);
        if (!m) {
        ...
        switch (measure) {
            case 'ms':
                ...
                break;
            case 's':
                _this._delay = number * 1000;
                break;
            case 'm':
                _this._delay = number * 1000 * 60;
                break;
            default:
                throw new Error('Invalid measure: ' + el);
        }
    ...
    Debounce.is = function (el) {
        return /^debounce\(\d+(ms|s|m)\)$/.test(el);
    };
    Debounce.prototype.get_delay_as_ms = function () {
        return this._delay;
    };
    return Debounce;
}(Modificator));
exports.Debounce = Debounce;
var Changed = /** @class */ (function (_super) {
    __extends(Changed, _super);
    function Changed(el) {
        var _this = _super.call(this) || this;
        var m = el.match(/^changed\(([\w\.]+)\)$/);
        if (!m) {
            throw new Error('Invalid modifictor: ' + el);
        }
        _this.prop = m[1];
...
"use strict";
/*!*********************************!*\
  !*** ./client/example_start.js ***!
  \*********************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _ignis__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ignis */ "./client/ignis.ts");



_ignis__WEBPACK_IMPORTED_MODULE_0__["default"].start({
  onError(err) {
