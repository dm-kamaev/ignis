...
/***/ "./client/Manager_Long_Request.js":
/*!****************************************!*\
  !*** ./client/Manager_Long_Request.js ***!
  \****************************************/
...
/* harmony export */   "default": () => (/* binding */ Manager_Long_Request)
/* harmony export */ });

class Manager_Long_Request {
...
var Manager_Long_Request_1 = __webpack_require__(/*! ./Manager_Long_Request */ "./client/Manager_Long_Request.js");
var Executor = /** @class */ (function () {
    ...
    Executor.prototype.run_as_form = function (e, cmd) {
        var _a;
        e.preventDefault();
        ...
        var headers = this._build_headers({ id: id, output_id: output_id });
    ...
    Executor.prototype.run_as_el = function (e, cmd) {
        e.preventDefault();
        this._run(cmd);
    };
    Executor.prototype.run_as_every = function (cmd) {
        this._run(cmd);
    };
    Executor.prototype._run = function (cmd) {
        var axios = this.axios;
        var $el = this.$el;
        var id = $el.id;
        var output_id = $el.getAttribute('data-i-output-id');
    ...
    Executor.prototype._handle_response = function (resp) {
        var _this = this;
        var config = resp.config, headers = resp.headers, data = resp.data;
        ...
        if (data instanceof Array) {
            data.forEach(function (cmd) { return _this._apply_response(cmd, url); });
        }
        else if (data) {
            this._apply_response({ ev: 'update', data: { html: data, css: null } }, url);
        }
    ...
    Executor.prototype._apply_response = function (resp, url) {
        if (resp.ev === 'update') {
            ...
            (0, helper_1.getById)(resp.data.id).outerHTML = '';
        }
        else if (resp.ev === 'append_to_top') {
            var _b = resp.data, id = _b.id, html = _b.html, css = _b.css;
            this._apply_css(css);
            (0, helper_1.getById)(id).insertAdjacentHTML('afterbegin', html);
        }
        else if (resp.ev === 'append_to_end') {
            var _c = resp.data, id = _c.id, html = _c.html, css = _c.css;
            this._apply_css(css);
            (0, helper_1.getById)(id).insertAdjacentHTML('beforeend', html);
        }
        else {
            throw new Error('Invalid command ' + JSON.stringify(resp));
        }
    };
    Executor.prototype._render = function (id, html) {
        ...
        (0, morphdom_1.default)(target, html, get_options());
    };
...
var ATTR_USE_PREV_VALUE = 'data-i-preserve';
...
var Manager = /** @class */ (function () {
    ...
    Manager.prototype._bind_cmd = function (el, _a) {
        ...
        var cb = function (e) {
            ...
            console.log(name, Every.is(name));
            var exec;
            if (name === 'submit') {
                exec = function () { return executor.run_as_form(e, cmd); };
            }
            else {
                exec = function () { return executor.run_as_el(e, cmd); };
            }
            var mods = cmd.mods;
            if (mods.changed) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getTarget = exports.addCss = exports.getById = void 0;
var D = document;
